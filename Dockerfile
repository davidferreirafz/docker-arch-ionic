...
RUN cd /opt/download && sudo -u user wget https://aur.archlinux.org/cgit/aur.git/snapshot/android-sdk.tar.gz && sudo -u user tar -zxvf android-sdk.tar.gz && cd /opt/download/android-sdk && sudo -u user makepkg
